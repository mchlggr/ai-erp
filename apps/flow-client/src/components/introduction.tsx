      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription className={'text-black space-y-4'}>
            <p>
              A simple project experimenting with how to build an AI-powered
              flowchart diagramming assistant.
            </p>
            <h2 className="text-lg font-bold">Overview</h2>
            <p>
              This project showcases basic integration between an AI model and
              flowchart tools, allowing a focused space to experiment with
              prompting for diagram generation.
            </p>
